...
app.layout = html.Div([
    ...
    html.Div([
        ...
        ],style={'width': '28%', 'float': 'middle','display': 'inline-block','padding-right':'5px','padding-bottom':'2%'}),
    html.Div([
        html.H4('Risk and Financial Measures'),
        html.Table(id = 'my-risk'),
        ],style={'width': '28%', 'float': 'right','display': 'inline-block','padding-right':'5px','padding-bottom':'2%'}),
    html.Div([
